...
RecipeFridge is an application that allows you to create your own recipe, or view and save recipes from other users on the app. You can even search for recipes based on ingredients in your refrigerator!
